namespace CyberBulb
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "免责声明：使用本软件将可能会对电脑造成可恢复但恢复难度较大的伤害，点击下方按钮即表示你已知晓该软件的潜在风险，并同意独自承担使用本软件所造成的一切损失。";
            // 
            // trackBar1
            // 
            this.trackBar1.Location = new System.Drawing.Point(146, 88);
